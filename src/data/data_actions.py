...
def del_products(prod_id: str, url: str = PRODS_URI) -> dict:
    return requests.delete(url + prod_id).json()


def add_product(name: str, description: str, img_url: str, price: float, url: str = PRODS_URI) -> dict:
    body = dict(    
        name=name,
